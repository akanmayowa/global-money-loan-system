            ...
            <div class="col-md-8 col-sm-4">
                ...
                <form @submit.prevent="updateCustomer">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" v-model="customer.phone_number" >
                    </div>
                    ...
                    <button type="submit" class="btn btn-success btn-md form-control">Update Customer</button>
                </form>
            </div>
    </div>
</template>
...
export default {
    ...
    created() {
                  this.axios.get(`http://localhost:8000/api/customers/${this.$route.params.id}`)
                .then(response => (
